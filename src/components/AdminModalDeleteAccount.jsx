...
function AdminModalDeleteAccount({ show, onHide, user }) {
  ...
  return (
    <>
      <Modal show={show} onHide={onHide}>
        ...
        <Modal.Body>
          Sei sicuro di voler eliminare l'account di {user.name} {user.surname}? Tutti i dati saranno cancellati e non saremo in grado di recuperarli
        </Modal.Body>
...
export default AdminModalDeleteAccount;
